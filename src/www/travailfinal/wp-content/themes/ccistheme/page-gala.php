                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            <div id="margedroite" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <h5 class="">Gagnant : Synapse Électronique</h5>
                                <h5 class="">Finaliste : Synapse Électronique</h5>
                                <h5 class="">Finaliste : Shawinigan Aluminium</h5>
                                ...
                                <h5 class="">Finaliste : Pépinière du Parc</h5>
                                <h5 class="">Finaliste : Location et service Patrice Raiche mini-mécanique Inc</h5>
                                ...
                                <h5 class="">Finaliste : Transport Chaîné Inc</h5>
                                <h5 class="">Finaliste : Comméléo Inc</h5>
                                <h5 class="">Finaliste : Val-Mauricie électrique</h5>
                                ...
                                <h5 class="">Finaliste : La Corporation TGV Net Mauricie</h5>
                                <h5 class="">Finaliste : 92,9 CFUT</h5>
                                ...
                                <h5 class="">Finaliste : Fix-auto Shawinigan-Sud</h5>
                                <h5 class="">Finaliste : ICO Technologies Inc</h5>
                        ...
                        <!-- Sidebar -->
                        <aside class="hidden-xs hidden-sm col-md-3 col-lg-3 aside-gala">
                            <ul>
                                <!-- Côté droit -->
