                                ...
                                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1">
                                    ...
                                    <div id="post-type" class="text-center center">
                                        <ul>
                                            ...
                                            <li><a class="current" href="http://localhost:8000/travailfinal/index.php/blogue-grands-dossiers">Grand dossiers</a></li>
                                        ...
                                        <select ONCHANGE="location = this.options[this.selectedIndex].value;">
                                            ...
                                            <option value="http://localhost:8000/travailfinal/index.php/blogue-grands-dossiers" selected="selected">Grand dossiers</option>
